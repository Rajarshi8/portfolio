...
export const fallbackProjects = [
  ...
  },
  {
    ...
    longDescription: 'SynapseAudit is a Security Audit SaaS Platform that provides automated code security scanning and vulnerability detection. Features include SQL injection detection, XSS prevention, hardcoded secrets scanning, security dashboard, and VS Code extension integration.',
    technologies: ['React', 'Node.js', 'Appwrite', 'Clerk', 'Tailwind CSS'],
    thumbnailUrl: '/videos/synapseaudit.mp4',
    images: [],
